...
@section('page-title')
    @include('admin.components.page-title', ['title' => __("Edit Vendor")])
@endsection
...
@section('content')
    <form action="{{ route('admin.vendors.update', $vendor->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">{{ __("Edit Vendor Registration Form") }}</h5>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="business_name" name="business_name" value="{{ old('business_name', $vendor->business_name) }}" required>
                    @error('business_name')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="address" name="address" value="{{ old('address', $vendor->address) }}" required>
                    @error('address')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" class="form-control" id="sec_registration" name="sec_registration">
                    @if($vendor->sec_registration)
                        <a href="{{ Storage::url($vendor->sec_registration) }}" target="_blank">View Current File</a>
                    @endif
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" class="form-control" id="bir_registration" name="bir_registration">
                    @if($vendor->bir_registration)
                        <a href="{{ Storage::url($vendor->bir_registration) }}" target="_blank">View Current File</a>
                    @endif
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" class="form-control" id="dti_registration" name="dti_registration">
                    @if($vendor->dti_registration)
                        <a href="{{ Storage::url($vendor->dti_registration) }}" target="_blank">View Current File</a>
                    @endif
