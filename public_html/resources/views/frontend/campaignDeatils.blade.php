                            ...
                            <div class="donation-form-wrapper">
                                ...
                                <div class="radio-wrapper">
                                    <div class="radio-item">
                                        <input type="radio" id="level-1" value="100" name="select_amount">
                                        <label for="level-1">100 {{ get_default_currency_code() }}</label>
                                    </div>
                                    <div class="radio-item">
                                        <input type="radio" id="level-2" value="500" name="select_amount">
                                        <label for="level-2">500 {{ get_default_currency_code() }}</label>
                                    </div>
                                    <div class="radio-item">
                                        <input type="radio" id="level-3" value="1000" name="select_amount">
                                        <label for="level-3">1000 {{ get_default_currency_code() }}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="donation-form-wrapper">
